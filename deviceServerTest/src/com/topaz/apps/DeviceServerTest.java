...
/**
 * The class <code>DeviceServerTest</code> contains tests for the class <code>{@link DeviceServerTest}</code>.
 *
...
public class DeviceServerTest {
	...
	public void testDeviceServer_1()
		throws Exception {
		DeviceServerTest result = new DeviceServerTest();
